...
const pillars = [
  { title: "Offer & Positioning", desc: "Clear value proposition, hook and campaign angle.", icon: Sparkles },
  { title: "Audience Strategy", desc: "Cold, warm, retargeting and lookalike audience structure.", icon: Target },
  { title: "Creative Testing", desc: "Static, carousel, video, UGC and multiple message angles.", icon: Megaphone },
  { title: "Funnel Design", desc: "Landing page, lead form, WhatsApp and conversion flow.", icon: Layers3 },
  { title: "Retargeting", desc: "Bring back viewers, clickers and website visitors.", icon: Repeat2 },
  { title: "Optimization", desc: "Scale winners and cut campaigns that waste budget.", icon: BarChart3 },
];
        ...
        <div className="grid gap-14 lg:grid-cols-[0.75fr_1.25fr]">
          <div className="lg:sticky lg:top-28 lg:self-start">
            ...
            <h2 className="mt-4 text-5xl font-semibold leading-[0.88] tracking-[-0.065em] md:text-7xl">
              Profitable ads are built from connected systems.
            </h2>
            <p className="mt-6 text-lg font-semibold leading-8 text-black/50">
              Each layer supports the next. Strong creative gets attention,
              targeting improves relevance and optimization turns data into growth.
            </p>
          </div>
